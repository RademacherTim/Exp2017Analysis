...
# interpolate linearly for tree 06M
...
plot (y = xPositions [1],
      ...
      col = colours [1], las = 1, pch = 1, cex = 2, lwd = 3, yaxt = 'n',
      ylim = c (0, 6), xlim = as_date (c ('2017-03-01','2017-11-15')))
arrows (x0 = as_date (mean (lastDates [[2]]) - sd (lastDates [[2]])), 
        x1 = as_date (mean (lastDates [[2]]) + sd (lastDates [[2]])),
        y0 = xPositions [1], col = colours [1], lwd = 3, angle = 90, length = 0.15, code = 3)
points (y = xPositions [1],
      x = as_date (mean (lastDates [[2]])), 
      col = colours [1], las = 1, pch = 21, cex = 2, lwd = 3, bg = colours [1])
...
arrows (x0 = as_date (mean (lastDates [[2]]) - sd (lastDates [[2]])), 
        x1 = as_date (mean (lastDates [[2]]) + sd (lastDates [[2]])),
        y0 = xPositions [2], col = colours [2], lwd = 3, angle = 90, length = 0.15, code = 3)
...
arrows (x0 = as_date (mean (lastDates [[2]]) - sd (lastDates [[2]])), 
        x1 = as_date (mean (lastDates [[2]]) + sd (lastDates [[2]])),
        y0 = xPositions [3], col = colours [2], lwd = 3, angle = 90, length = 0.15, code = 3)
points (y = xPositions [3],
      x = as_date (mean (lastDates [[2]])), 
      col = colours [2], las = 1, pch = 21, cex = 2, lwd = 3, bg = colours [2])
...
arrows (x0 = as_date (mean (lastDates [[2]]) - sd (lastDates [[2]])), 
        x1 = as_date (mean (lastDates [[2]]) + sd (lastDates [[2]])),
        y0 = xPositions [4], col = colours [3], lwd = 3, angle = 90, length = 0.15, code = 3)
...
arrows (x0 = as_date (mean (lastDates [[2]]) - sd (lastDates [[2]])), 
        x1 = as_date (mean (lastDates [[2]]) + sd (lastDates [[2]])),
        y0 = xPositions [5], col = colours [3], lwd = 3, angle = 90, length = 0.15, code = 3)
points (y = xPositions [5],
      x = as_date (mean (lastDates [[2]])), 
      col = colours [3], las = 1, pch = 21, cex = 2, lwd = 3, bg = colours [3])
...
arrows (x0 = as_date (mean (lastDates [[2]], na.rm = TRUE) - sd (lastDates [[2]], na.rm = TRUE)), 
        ...
        y0 = xPositions [6], col = colours [4], lwd = 3, angle = 90, length = 0.15, code = 3)
points (y = xPositions [6],
      x = as_date (mean (lastDates [[2]], na.rm = TRUE)), 
      col = colours [4], las = 1, pch = 21, cex = 2, lwd = 3, bg = 'white')
# determine the last day of growth for below the double compression
treeLabels <- c ('02M','08M','14M','22M','24M','25M','26M','27M','34M','37M')
lastDates <- aggregate (data [['formationDate']] [data [['YEAR']] == 2017 & data [['TREE']] %in% treeLabels], 
                        by = list (data [['TREE']] [data [['YEAR']] == 2017 & data [['TREE']] %in% treeLabels]), 
...
arrows (x0 = as_date (mean (lastDates [[2]]) - sd (lastDates [[2]])), 
        x1 = as_date (mean (lastDates [[2]]) + sd (lastDates [[2]])),
        y0 = xPositions [7], col = colours [4], lwd = 3, angle = 90, length = 0.15, code = 3)
points (y = xPositions [7],
      x = as_date (mean (lastDates [[2]])), 
      col = colours [4], las = 1, pch = 21, cex = 2, lwd = 3, bg = '#999999')
...
arrows (x0 = as_date (mean (lastDates [[2]], na.rm = TRUE) - sd (lastDates [[2]], na.rm = TRUE)), 
        x1 = as_date (mean (lastDates [[2]], na.rm = TRUE) + sd (lastDates [[2]], na.rm = TRUE)),
        y0 = xPositions [8], col = colours [4], lwd = 3, angle = 90, length = 0.15, code = 3)
points (y = xPositions [8],
      x = as_date (mean (lastDates [[2]], na.rm = TRUE)), 
      col = colours [4], las = 1, pch = 21, cex = 2, lwd = 3, bg = colours [4])
# add y axis
axis (side = 2, at = xPositions, 
      labels = c ('1 M','2 B','2 A','3 B','3 A','4 B','4 M','4 A'), 
      tick = 1, las = 1)
# TR - Got to this point with cleaning up!!!
