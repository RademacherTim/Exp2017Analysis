...
We calculate the daily rate of structural carbon gain similar to @cuny_woody_2015. We derived the rate of primary cell wall formation ($r_{w,cz}, \mu m \, day^{-1}$) from the rate of cell production ($r_c$) according to the first equation on page 9 of the supplementary material.
