...
``` {r totalBiomass}
biomass04 <- exp (2.4800 + 2.4835 * log (allometricData [['cbh150']] / pi))  
...
$$
``` {r fractionalBiomass}
rootFraction <- exp (-1.5619 + ( 0.6614 / (allometricData [['cbh150']] / pi)))
stemFraction <- exp (-0.3737 + (-1.8055 / (allometricData [['cbh150']] / pi)))
barkFraction <- exp (-2.0980 + (-1.1432 / (allometricData [['cbh150']] / pi)))
foliFraction <- exp (-2.9584 + ( 4.4766 / (allometricData [['cbh150']] / pi)))
